//
//  TestUICollectionPagedUITests.swift
//  TestUICollectionPagedUITests
//
//  Created by fauquette fred on 29/12/15.
//  Copyright © 2015 mobi.inthepocket. All rights reserved.
//

import XCTest

class TestUICollectionPagedUITests: XCTestCase {
